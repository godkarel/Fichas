...
local function constructNew_frmpersonagem()
    ...
    obj.button1:setLeft(352);
    obj.button1:setTop(505);
    obj.button1:setWidth(90);
    obj.button1:setHeight(110);
    obj.button1:setOpacity(0.6);
    obj.button1:setText("");
    ...
    obj.button3:setLeft(468);
    obj.button3:setTop(505);
    obj.button3:setWidth(90);
    obj.button3:setHeight(110);
    obj.button3:setOpacity(0.6);
    obj.button3:setText("");
    ...
    obj.dataLink2:setFields({'MontSabedoria', 'MontAcrobacia', 'MontVigor', 'PA', 'PM', 'PF', 'Forca', 'Inteligencia', 'Destreza', 'Agilidade', 'Vitalidade',
	 'ArmaPA', 'ArmaDEF', 'ArmaPM', 'ArmaRES', 'ARMAPF', 'ArmaHP', 'ArmaMP', 'Atletismo', 'Acrobacia', 'MontAtletismo', 'Sabedoria', 'Vigor', 'Percepcao', 'MontPercepcao' });
    obj.dataLink2:setName("dataLink2");

    obj.button4 = GUI.fromHandle(_obj_newObject("button"));
    obj.button4:setParent(obj.scrollBox1);
    obj.button4:setLeft(62);
    obj.button4:setTop(80);
    ...
    obj._e_event4 = obj.dataLink2:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            sheet.TAtletismo = (tonumber(sheet.ForcaTotal) or 0) /10 + (tonumber(sheet.Atletismo) or 0) + (tonumber(sheet.MontAtletismo) or 0)
            		sheet.TSabedoria = (tonumber(sheet.InteligenciaTotal) or 0) /10 + (tonumber(sheet.Sabedoria) or 0) + (tonumber(sheet.MontSabedoria) or 0)
            		sheet.TPercepcao = (tonumber(sheet.DestrezaTotal) or 0) /10 + (tonumber(sheet.Percepcao) or 0) + (tonumber(sheet.MontPercepcao) or 0)
            		sheet.TVigor = (tonumber(sheet.VitalidadeTotal) or 0) /10 + (tonumber(sheet.Vigor) or 0) + (tonumber(sheet.MontVigor) or 0)
            		sheet.TAcrobacia = (tonumber(sheet.AgilidadeTotal) or 0) /10 + (tonumber(sheet.Acrobacia) or 0) + (tonumber(sheet.MontAcrobacia) or 0)
        end, obj);
