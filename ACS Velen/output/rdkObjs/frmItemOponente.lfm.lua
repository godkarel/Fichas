...
local function constructNew_frmItemOponente()
    ...
    obj.label1:setField("NomeDoOponenteVez");
    ...
    obj.progressBar1:setField("HPBarO");
    obj.progressBar1:setFieldMax("HPBarMaxO");
    ...
    obj.progressBar2:setField("MPBarO");
    obj.progressBar2:setFieldMax("MPBarMaxO");
...
function newfrmItemOponente()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmItemOponente();
      end,
      function()
...
local _frmItemOponente = {
    newEditor = newfrmItemOponente, 
    new = newfrmItemOponente, 
    name = "frmItemOponente", 
    dataType = "", 
    formType = "undefined", 
...
frmItemOponente = _frmItemOponente;
Firecast.registrarForm(_frmItemOponente);

return _frmItemOponente;
