...
local function constructNew_frmSCV4SobrePosta()
    ...
    obj._e_event4 = obj.btnPopREDPJ1:addEventListener("onClick",
        function (event)
    ...
    obj._e_event9 = obj.btnPopREDPJ2:addEventListener("onClick",
        function (event)
    ...
    obj._e_event14 = obj.btnPopREDPJ3:addEventListener("onClick",
        function (event)
    ...
    obj._e_event19 = obj.btnPopREDPJ4:addEventListener("onClick",
        function (event)
    ...
    obj._e_event24 = obj.btnPopREDPJ5:addEventListener("onClick",
        function (event)
    ...
    obj._e_event29 = obj.btnPopREDPJ6:addEventListener("onClick",
        function (event)
    ...
    obj._e_event34 = obj.btnPopREDPJ7:addEventListener("onClick",
        function (event)
    ...
    obj._e_event37 = obj.button31:addEventListener("onClick",
        function (event)
            if self.cmbInimigo7.text == sheet.NomeJ1 then			
            						sheet.Macete7 = (tonumber(sheet.DanoJ7) or 0) + (tonumber(sheet.BuffDNJ7) or 0)
    ...
    obj._e_event38 = obj.button32:addEventListener("onClick",
        function (event)
            self.PopJ8:show();
        end);

    obj._e_event39 = obj.btnPopREDPJ8:addEventListener("onClick",
        function (event)
    ...
    obj._e_event44 = obj.btnPopREDPJ9:addEventListener("onClick",
        function (event)
    ...
    obj._e_event49 = obj.btnPopREDPJ10:addEventListener("onClick",
        function (event)
    ...
    obj._e_event51 = obj.button42:addEventListener("onClick",
        function (event)
            if self.cmbInimigo10.text == sheet.NomeJ1 then
            						sheet.Macete10 = (tonumber(sheet.DanoJ10) or 0) + (tonumber(sheet.BuffDNJ10) or 0)				 				 
            						sheet.Macete10 = (tonumber(sheet.Macete10) or 0) /100
    ...
    obj._e_event52 = obj.button43:addEventListener("onClick",
        function (event)
            if self.cmbInimigo10.text == sheet.NomeJ1 then			
            						sheet.Macete10 = (tonumber(sheet.DanoJ10) or 0) + (tonumber(sheet.BuffDNJ10) or 0)
    ...
    obj._e_event53 = obj.button44:addEventListener("onClick",
        function (event)
            sheet.turno = 0
...
function newfrmSCV4SobrePosta()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmSCV4SobrePosta();
      end,
      function()
...
local _frmSCV4SobrePosta = {
    newEditor = newfrmSCV4SobrePosta, 
    new = newfrmSCV4SobrePosta, 
    name = "frmSCV4SobrePosta", 
    dataType = "", 
    formType = "undefined", 
...
frmSCV4SobrePosta = _frmSCV4SobrePosta;
Firecast.registrarForm(_frmSCV4SobrePosta);

return _frmSCV4SobrePosta;
